...
public class Map : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        if (DataLoader.enableclick && !CameraMovement.movement)
        {
            ...
            transform.GetChild(0).transform.localScale = new Vector3(1f, 1f, 1);
            ...
            CUtils.analyticsEvent(CommonConst.click_level_number, "Level", map.Level + "");//统计用户主动点击关卡
            // PlayerPrefs.SetInt(PrefKeys.HISTORY_LEVEL, map.Level);
            GameState.toGameScene(map.Level);
        }
        CameraMovement.movement = false;
    }
    /// <summary>
