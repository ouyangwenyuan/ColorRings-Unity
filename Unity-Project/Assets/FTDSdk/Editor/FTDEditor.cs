...
public class FTDEditor
{
    ...
    private static void RunPostProcessTasksAndroid()
    {
        ...
        string ftdManifestPath = Path.Combine(Application.dataPath, "FotoabaleSdk/Android/FTDSdkAndroidManifest.xml");
    ...
    private static void AddBroadcastReceiver(XmlDocument manifest)
    {
        ...
        if (isThereAnyCustomBroadcastReiver)
        {
            ...
            UnityEngine.Debug.Log("FTD: Please, add the calls to the ftd broadcast receiver like described in here: https://github.com/ftd/android_sdk/blob/master/doc/english/referrer.md");
        }
        else
        {
